        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center gap-8">
              ...
              >
                <button
                  ...
                  className={`text-sm font-bold uppercase tracking-wide transition-colors flex items-center gap-1 ${
                    currentPage === link.id || (link.id === 'services' && serviceItems.some(s => s.id === currentPage)) 
                    ? 'text-brand-blue' 
            ...
            <button 
              ...
              className="btn-accent px-6 py-2.5 rounded text-sm font-bold uppercase tracking-widest shadow-md hover:scale-105 hover:brightness-110 active:scale-95 transition-all duration-200"
            >
              Consultation
            </button>
          </div>
