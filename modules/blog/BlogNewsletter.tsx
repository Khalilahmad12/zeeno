      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-bold text-primary-dark mb-4">Stay Updated With Our Latest Insights</h2>
            ...
            <p className="mt-4 text-xs text-text-light/70 italic">We promise not to spam you. You can unsubscribe at any time.</p>
          </div>
        </motion.div>
      </div>
    </section>
