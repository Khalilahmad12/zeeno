      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-start text-left">
            ...
            <h3 className="text-3xl md:text-5xl font-extrabold text-primary-dark mb-4 leading-[1.2] hover:text-primary transition-colors cursor-pointer tracking-tight">
              Mastering the Art of Data-Driven Strategy for Modern Enterprises
            </h3>
