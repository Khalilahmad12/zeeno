...
const AcademyCTA: React.FC = () => {
  return (
    <section className="py-24 bg-[#05080F] relative overflow-hidden text-white">
      ...
      >
        <span className="text-brand-blue font-black text-[10px] uppercase tracking-[0.4em] mb-8 block">Ready to Transform?</span>
        <h2 className="text-5xl md:text-7xl font-black mb-8 tracking-tighter leading-tight uppercase">
          Start Your Tech <br />
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <motion.button 
            ...
            whileTap={{ scale: 0.95 }}
            className="w-full sm:w-auto bg-brand-orange text-white px-14 py-5 rounded-xl font-black text-xs uppercase tracking-widest shadow-2xl shadow-brand-orange/30 flex items-center justify-center gap-3"
          >
          ...
          <motion.button 
            whileHover={{ scale: 1.05, y: -5 }}
            whileTap={{ scale: 0.95 }}
            className="w-full sm:w-auto bg-white/5 border-2 border-white/20 text-white px-14 py-5 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-white hover:text-brand-dark transition-all flex items-center justify-center gap-3"
          >
            <MessageSquare size={18} /> Speak to Advisor
          </motion.button>
        </div>
        
        <p className="mt-12 text-[10px] font-black uppercase tracking-[0.3em] text-gray-500">
