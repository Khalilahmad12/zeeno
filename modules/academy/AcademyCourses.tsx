  ...
  return (
    <section className="py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="text-brand-blue font-black text-[10px] uppercase tracking-[0.3em] mb-4 block">Curriculum</span>
          <h2 className="text-4xl md:text-5xl font-black text-brand-dark mb-6 tracking-tighter">Our Professional <span className="text-brand-orange">Programs</span></h2>
        ...
        >
          {courses.map((course, idx) => (
            ...
            >
              <h3 className="text-2xl font-bold text-brand-dark mb-4 group-hover:text-brand-blue transition-colors uppercase tracking-tight">{course.title}</h3>
              ...
              <button className="w-full bg-slate-50 text-brand-dark py-4 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-brand-blue hover:text-white transition-all shadow-sm border border-slate-100 active:scale-95">
                Enroll Now
              </button>
            </motion.div>
          ))}
