      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {features.map((feature, idx) => (
            ...
            >
              <div className="w-20 h-20 bg-white text-brand-blue rounded-2xl flex items-center justify-center mx-auto mb-8 shadow-sm group-hover:bg-brand-orange group-hover:text-white transition-all duration-700 transform group-hover:rotate-[360deg] border border-slate-100">
                {feature.icon}
              </div>
              <h4 className="text-xl font-bold text-brand-dark mb-4 group-hover:text-brand-blue transition-colors duration-500 uppercase tracking-tight">{feature.title}</h4>
