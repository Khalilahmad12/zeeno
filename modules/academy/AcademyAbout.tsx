    ...
    <section className="py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <motion.span variants={fadeUp} className="text-brand-blue font-black text-[10px] uppercase tracking-[0.3em] mb-4 block">About the Academy</motion.span>
            <motion.h2 variants={fadeUp} className="text-4xl md:text-5xl font-black text-brand-dark mb-8 tracking-tighter leading-tight">
              Our Mission to Shape <br />
              <span className="text-brand-orange">Global Tech Talent</span>
            </motion.h2>
            <motion.p variants={fadeUp} className="text-slate-500 text-lg mb-10 leading-relaxed font-medium">
            ...
            >
              {highlights.map((item, idx) => (
                ...
                >
                  ...
                  <h4 className="font-bold text-brand-dark mb-2 text-lg tracking-tight uppercase">{item.title}</h4>
          ...
          >
            ...
            >
              <div className="text-brand-orange text-5xl font-black mb-1">95%</div>
              <div className="text-slate-400 font-black uppercase text-[10px] tracking-widest">Placement Rate</div>
            </motion.div>
          </motion.div>
        </div>
      </div>
