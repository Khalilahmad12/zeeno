  ...
  const projects: Project[] = [
    {
      ...
      category: 'Enterprise',
      desc: 'Robust multi-vendor architecture handling complex supply chains with real-time logic.',
      longDesc: 'Architected for global scalability, this platform integrates sophisticated inventory management with real-time sync capabilities across multi-continental warehouses.',
    ...
    },
    {
      title: 'FinEdge Intel',
      category: 'Fintech',
      desc: 'Institutional-grade data visualization and predictive market analytics dashboard.',
      longDesc: 'A high-fidelity financial dashboard providing real-time market intelligence using high-performance WebGL rendering for zero-latency charting.',
      image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=1200',
      imageAlt: 'Fintech Analytics',
      tags: ['D3.js', 'Go', 'React'],
    ...
    },
    {
      title: 'MediConnect',
      category: 'Healthcare',
      desc: 'Secure HIPAA-compliant telemedicine hub with integrated biometric synchronization.',
      longDesc: 'Engineered for reliability, this medical platform offers encrypted video consultations and automated patient health records management.',
      image: 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&q=80&w=1200',
      imageAlt: 'Healthcare Hub',
    ...
    },
    {
      title: 'Swift Logix',
      category: 'Logistics',
      desc: 'Autonomous fleet optimization system using AI-driven route forecasting.',
      longDesc: 'Modern logistics tracking utilizing IoT sensors and predictive modeling to optimize delivery paths and reduce operational overhead by 22%.',
      image: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&q=80&w=1200',
      imageAlt: 'Logistics platform',
      tags: ['Python', 'Docker', 'Google Maps'],
      color: 'bg-blue-600',
      demoUrl: '#'
    },
    {
      ...
      category: 'Studio',
      desc: 'Award-winning design portfolio focusing on high-fidelity interaction paradigms.',
      longDesc: 'A deep dive into kinetic typography and immersive visual storytelling, pushing the boundaries of traditional web interaction.',
      image: 'https://images.unsplash.com/photo-1558655146-d09347e92766?auto=format&fit=crop&q=80&w=1200',
      imageAlt: 'Design Portfolio',
      tags: ['Three.js', 'Next.js', 'Figma'],
      color: 'bg-pink-500',
      demoUrl: '#'
    },
    {
      title: 'Urban Grid',
      category: 'Smart City',
      desc: 'IoT-enabled urban management dashboard for power and traffic distribution.',
      longDesc: 'Engineering the infrastructure of tomorrow with centralized data visualization from thousands of urban sensor points.',
      image: 'https://images.unsplash.com/photo-1449824913935-59a10b8d2000?auto=format&fit=crop&q=80&w=1200',
      imageAlt: 'Smart City Interface',
      tags: ['Node.js', 'MQTT', 'Grafana'],
      color: 'bg-brand-dark',
      demoUrl: '#'
    }
  ];
