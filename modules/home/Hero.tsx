            ...
            >
              <div className="relative rounded-[2rem] overflow-hidden border-[12px] border-white/5 shadow-2xl bg-white/5">
                <motion.img 
                  ...
                  className="w-full lg:h-[600px] object-cover opacity-90  hover:opacity-100 transition-all duration-[2s]"
                />
              ...
              <motion.div
                ...
                className="absolute hidden md:block -top-12 -right-8 bg-brand-dark/80 backdrop-blur-2xl border border-white/10 p-7 rounded-2xl shadow-xl z-30 min-w-[200px]"
              >
