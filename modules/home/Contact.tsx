    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="text-center mb-10 relative z-10">
        ...
        <motion.h2 
          ...
          viewport={{ once: true }}
          className="text-4xl lg:text-6xl font-bold mb-4 text-slate-900 dark:text-white tracking-tighter"
        >
        ...
        >
          {contactInfo.map((info, idx) => (
            ...
            >
              ...
              <div className="w-14 h-14 rounded-xl bg-slate-50 dark:bg-white/5 flex items-center justify-center shrink-0 group-hover:bg-brand-blue group-hover:text-white group-hover:rotate-[360deg] transition-all duration-700 text-brand-blue shadow-sm">
                {info.icon}
              </div>
              <div>
          ...
          <motion.div 
            variants={itemVariants}
            className="pt-10 border-t border-black/5 dark:border-white/5"
          >
            ...
            <div className="flex gap-4">
              {['FB', 'TW', 'LI', 'IG'].map((social) => (
                <a 
                  key={social} 
                  href="#" 
                  className="w-12 h-12 bg-white dark:bg-[#111] border border-black/5 dark:border-white/10 rounded-lg flex items-center justify-center text-xs font-bold text-slate-600 dark:text-gray-400 hover:bg-brand-blue hover:text-white hover:border-brand-blue hover:-translate-y-1 transition-all duration-300"
                >
                  {social}
                </a>
              ))}
        ...
        >
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8 relative z-10">
              <div className="space-y-3">
                ...
                <input 
                  ...
                  className="w-full bg-slate-50 dark:bg-white/[0.03] border border-black/5 dark:border-white/10 rounded-lg px-5 py-4 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-blue/20 focus:border-brand-blue transition-all font-medium placeholder:text-slate-300 dark:placeholder:text-gray-700" 
                />
              </div>
              <div className="space-y-3">
            ...
            <div className="space-y-3 relative z-10">
              ...
              <select className="w-full bg-slate-50 dark:bg-white/[0.03] border border-black/5 dark:border-white/10 rounded-lg px-5 py-4 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-blue/20 focus:border-brand-blue transition-all font-medium appearance-none cursor-pointer">
            ...
            <div className="space-y-3 relative z-10">
              ...
              <textarea 
                ...
                className="w-full bg-slate-50 dark:bg-white/[0.03] border border-black/5 dark:border-white/10 rounded-lg px-5 py-4 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-blue/20 focus:border-brand-blue transition-all font-medium placeholder:text-slate-300 dark:placeholder:text-gray-700 resize-none"
              ></textarea>
            </div>
            ...
            >
              <div className={`w-full bg-brand-orange hover:bg-brand-orange/90 text-white font-bold py-5 rounded-lg transition-all shadow-xl shadow-brand-orange/20 flex items-center justify-center gap-3 uppercase tracking-[0.2em] text-xs ${isSubmitting ? 'opacity-90' : ''}`}>
                {isSubmitting ? (
                  <>
