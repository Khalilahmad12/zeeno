        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            <div className="rounded-[2rem] overflow-hidden shadow-2xl relative group">
              <img 
                src="https://plus.unsplash.com/premium_photo-1684769161451-a9f1cccc5d50?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fGl0JTIwYWdlbmN5fGVufDB8fDB8fHww" 
                alt="Zeeno Globle Team Advantage" 
                className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700 aspect-[4/3]"
              />
            </div>
