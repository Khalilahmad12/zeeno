                     ...
                     <div className="space-y-6">
                        {[
                          ...
                          <motion.div 
                            ...
                            className="group flex gap-6 p-4 rounded-2xl shadow hover:bg-white/5 transition-all duration-300"
                          >
                             <div className="w-14 h-14 rounded-xl bg-blue-50 text-blue-500 flex items-center justify-center text-accent flex-shrink-0 group-hover:bg-accent group-hover:text-white group-hover:rotate-[360deg] transition-all duration-500">
                                {React.cloneElement(f.icon as React.ReactElement<{ size?: number }>, { size: 24 })}
                             </div>
                             <div>
                                <h4 className="text-xl font-bold mb-1 text-primary group-hover:text-accent transition-colors">{f.title}</h4>
                                <p className="text-gray-500 max-w-sm text-sm leading-relaxed">{f.desc}</p>
                             </div>
                          </motion.div>
                        ))}
                     </div>
