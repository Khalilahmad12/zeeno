      ...
      >
        ...
        >
          <motion.span 
            ...
            className="inline-block bg-brand-blue/10 text-brand-blue px-5 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.35em] mb-8 shadow-sm border border-brand-blue/20"
          >
            CONTACT US
          </motion.span>
          <motion.h1 
            variants={itemVariants}
            className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-6 leading-tight tracking-tighter"
          >
      ...
      <section className="py-12 md:py-24">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <motion.h2 
            ...
            className="text-2xl md:text-4xl font-black text-brand-dark mb-16 text-center tracking-tight uppercase"
          >
          ...
          <div className="flex flex-col lg:flex-row gap-12">
                ...
                {[
                  ...
                  >
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        <p className="text-[10px] font-black text-brand-blue uppercase tracking-[0.2em] mb-1">{info.label}</p>
                        {info.href ? (
            ...
            >
              <div className="bg-white p-8 md:p-12 rounded-[2rem] shadow-2xl shadow-slate-200/50 border border-slate-50 relative overflow-hidden group/form">
                ...
                <motion.h2 
                  variants={itemVariants}
                  className="text-3xl font-black text-brand-dark mb-8 relative z-10 tracking-tight uppercase"
                >
                  Send Us a Message
                </motion.h2>
                <motion.form 
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <motion.div variants={itemVariants}>
                      <label className="block text-[10px] font-black text-slate-400 mb-2 uppercase tracking-[0.2em] ml-1">Full Name</label>
                      <input 
                        type="text" 
                        required
                    ...
                    <motion.div variants={itemVariants}>
                      <label className="block text-[10px] font-black text-slate-400 mb-2 uppercase tracking-[0.2em] ml-1">Email Address</label>
                      <input 
                        type="email" 
                        required
                        className="w-full px-5 py-4 rounded-xl border border-slate-100 bg-slate-50 focus:bg-white focus:border-brand-blue focus:ring-4 focus:ring-brand-blue/5 outline-none transition-all text-sm font-medium" 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <motion.div variants={itemVariants}>
                      <label className="block text-[10px] font-black text-slate-400 mb-2 uppercase tracking-[0.2em] ml-1">Phone Number</label>
                      <input 
                        type="tel" 
                        className="w-full px-5 py-4 rounded-xl border border-slate-100 bg-slate-50 focus:bg-white focus:border-brand-blue focus:ring-4 focus:ring-brand-blue/5 outline-none transition-all text-sm font-medium" 
                    ...
                    <motion.div variants={itemVariants}>
                      <label className="block text-[10px] font-black text-slate-400 mb-2 uppercase tracking-[0.2em] ml-1">Subject</label>
                  ...
                  <motion.button 
                    ...
                    whileTap={{ scale: 0.98 }}
                    type="submit" 
                    className="w-full bg-brand-orange text-white py-5 rounded-xl font-black text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-3 hover:bg-opacity-90 transition-all shadow-xl shadow-brand-orange/20 active:scale-95"
                  >
      ...
      <section className="py-24 bg-brand-blue/5 text-center relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <motion.h2 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: false }}
            className="text-3xl md:text-5xl font-black mb-4 text-brand-dark tracking-tighter uppercase"
          >
          ...
          <motion.p 
            ...
            className="text-lg text-slate-500 mb-12 max-w-xl mx-auto font-medium"
          >
          ...
          >
            <motion.a 
              ...
              className="w-full sm:w-auto bg-brand-orange text-white px-10 py-4 rounded-xl font-black text-xs uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-opacity-90 transition-all shadow-xl shadow-brand-orange/20"
            >
            ...
            <motion.a 
              ...
              className="w-full sm:w-auto bg-white border-2 border-brand-blue text-brand-blue px-10 py-4 rounded-xl font-black text-xs uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-brand-blue hover:text-white transition-all"
            >
