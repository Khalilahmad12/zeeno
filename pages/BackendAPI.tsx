         ...
         <div className="container mx-auto px-4 md:px-6">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
               ...
               >
                  ...
                  <h4 className="text-2xl font-bold mb-8  text-accent flex items-center gap-4">
                     <div className="w-12 h-12 rounded-xl  bg-white/10 flex items-center justify-center group:text-white group-hover:bg-accent group-hover:rotate-[360deg] transition-all duration-500">
                      <Code className="text-accent group-hover:text-white" size={24} />
                     </div>
